        ...
        body: Consumer<ProductProvider>(
          builder: (context, value, child) => ListView.builder(
              ...
              itemBuilder: (context, index) => ListTile(
                    leading: Text("${productProvider!.cartData[index].image}",
                        style: TextStyle(fontSize: 30)),
                    title: Text(
                        "${productProvider!.cartData[index].productname}",
                        style: TextStyle(
                            fontSize: 15,
                            letterSpacing: 1,
                            fontWeight: FontWeight.w700)),
                    subtitle: Text("${productProvider!.productData[index].price}",
                        style: TextStyle(
                            fontSize: 18,
                            letterSpacing: 1,
                    ...
                    trailing: Row(
                      ...
                      children: [
                        IconButton(
                            onPressed: () {
                              ProductModel p1 = ProductModel(
                                  image:
                                      productProvider!.productData[index].image,
                                  price: productProvider!
                                          .productData[index].price! *
                                      2,
                                  productname: productProvider!
                                      .productData[index].productname,
                                  qa: productProvider!.productData[index].qa! +
                                      1);
                        ...
                        Padding(
                          ...
                          child:
                              Text("${productProvider!.productData[index].qa}"),
                        ),
                        IconButton(
                            onPressed: () {
                              ProductModel p1 = ProductModel(
